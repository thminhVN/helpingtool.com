 ...
 */
class StTag extends \Entity\StTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\StTag' . "\0" . 'id', '' . "\0" . 'Entity\\StTag' . "\0" . 'status', '' . "\0" . 'Entity\\StTag' . "\0" . 'priority', '' . "\0" . 'Entity\\StTag' . "\0" . 'page');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StTag $proxy) {
